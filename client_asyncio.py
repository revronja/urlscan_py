...
#     scanner.multi_scan("https://www.google.com","https://www.google.com")
# except:
#     pass
...
async def main(urls):
    ...
    print(urls)
    for url in urls:
        await asyncio.gather(scanner.multi_scan(url))

if __name__ == "__main__":
    urls = ["google.com","apple.com"]
    asyncio.run(main(urls))
    # for url in urls:
    #     await scanner.multi_scan(url)
